...
export default function AddIncomeScreen({ navigation, route }) {
  ...
  const headerTitle = isEditing ? "Edit Income" : "Add Income";
  ...
  useEffect(() => {
    ...
    if (Number.isFinite(rawAmount) && rawAmount > 0) {
      handleIncomeChange(String(rawAmount));
    }
    if (tx.category) {
          ...
          <View style={styles.pickerContent}>
            ...
            {Platform.OS === "ios" ? (
              <View style={styles.pickerActions}>
                ...
                <TouchableOpacity style={[styles.pickerButton, styles.pickerConfirm]} onPress={handlePickerConfirm}>
